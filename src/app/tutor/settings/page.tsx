...
export default async function TutorSettingsPage({
  ...
  const inviteUrl = workspace?.invite_token
    ? `${process.env.NEXT_PUBLIC_APP_URL}/join/${workspace.invite_token}`
    : null
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-2">
              Share this link with students to invite them to your workspace.
            </p>
            {inviteUrl ? (
              ...
              <p className="text-gray-500">No invite link generated.</p>
            )}
          </div>
        </div>
      </section>
        ...
        {googleConnection ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Sessions will automatically create Google Calendar events with Meet links.
            </p>
          ...
          <div className="space-y-4">
            <p className="text-gray-600">
              Connect Google Calendar to automatically create events for tutoring sessions
